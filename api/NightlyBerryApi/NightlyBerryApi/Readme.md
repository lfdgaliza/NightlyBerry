...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *NightlyBerryApi*):
...
Execute unit tests
```
    cd "NightlyBerryApi/test/NightlyBerryApi.Tests"
    dotnet test
```

Deploy application
```
    cd "NightlyBerryApi/src/NightlyBerryApi"
